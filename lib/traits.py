traits = {
    ...
    'underdark': {
                ...
                'effects': [
                    {
                        'amount': 5,
                        'text': 'At the start of an underdark\'s turn, if an ally has less hp then the underdark, the underdark consumes them, adding all of the ally\'s hp and stats (but not ac) to themselves.'
                    }
                ],
                'note': ''
            },
